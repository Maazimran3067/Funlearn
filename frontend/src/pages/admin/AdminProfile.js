...
export default function AdminProfile() {
  ...
  const handlePassword = async () => {
    if (newPass.length < 6) {
      showMsg('Min 6 characters!', 'error'); return;
    }
    setLoading(true);
    try {
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.content}>
        <h1 style={styles.pageTitle}>⚙️ Admin Profile</h1>
        {msg && (
          <div style={{
            ...styles.msg,
        ...
        <div style={styles.grid}>
          <motion.div style={styles.card}
            ...
            <h2 style={styles.cardTitle}>✏️ Edit Info</h2>
            {[
              ...
              <div key={i} style={styles.field}>
                ...
                <input style={styles.input} value={f.value}
          ...
          <motion.div style={styles.card}
            ...
            {[
              { label: 'Current Password', value: oldPass, set: setOldPass, ph: 'Current password' },
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.03 }} onClick={handlePassword}
              disabled={loading}>
              Change Password 🔒
            </motion.button>
          </motion.div>
          ...
          <motion.div style={styles.card}
            ...
            {[
              ...
              { label: 'Joined',   value: new Date(user?.date_joined)
              ...
              <div key={i} style={styles.infoRow}>
                ...
                <span style={styles.infoBadge}>{r.value}</span>
              </div>
            ))}
          </motion.div>
        </div>
...
const styles = {
  page:      { minHeight: '100vh', background: '#FEF2F2' },
  ...
  input: {
    ...
    border: '2px solid #FECACA', fontSize: 14, outline: 'none',
