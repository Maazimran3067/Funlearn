...
const NAV = [
  ...
  { label:'Assign Tasks', icon:'📋', path:'/teacher/tasks' },
  { label:'Game Library', icon:'🎮', path:'/teacher/games' },
];
            ...
            return (
              <motion.div key={n.path}
                ...
                <span style={{ fontSize:13, fontWeight:active?700:500,
                  color:active?COLOR:'#94A3B8', fontFamily:'Nunito,sans-serif' }}>{n.label}</span>
                {active && <motion.div layoutId="teacherActive"
