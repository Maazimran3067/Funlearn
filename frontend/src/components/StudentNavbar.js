            ...
            return (
              <motion.div key={n.path}
                ...
                <span style={{ fontSize:13, fontWeight:active?700:500,
                  color:active?'#818CF8':'#94A3B8', fontFamily:'Nunito,sans-serif' }}>
                  {n.label}
                </span>
                {active && <motion.div layoutId="sidebarActive"
                  style={{ marginLeft:'auto', width:4, height:4, borderRadius:'50%', background:'#6366F1' }}/>}
              </motion.div>
            );
          })}
        </div>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:10 }}>
            ...
            <div>
              <div style={{ fontSize:12, fontWeight:700, color:'#F1F5F9',
                fontFamily:'Nunito,sans-serif' }}>{user?.first_name} {user?.last_name}</div>
